    ...
    <>
      ...
      <AppBar position="static" color="transparent" elevation={0} sx={{ p: 1 }}>
        <Toolbar sx={{ display: "flex", justifyContent: "space-between" }}>
          ...
          <Box>
            <Button href="/register" sx={{ mr: 1 }}>Register</Button>
      ...
      <Container sx={{ mb: 8 }}>
        ...
        <Box sx={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: 3 }}>
          {[
            ...
            { title: "Easy Integration", desc: "Connect seamlessly with your existing tools and workflows." },
          ].map((item, i) => (
            <Paper
              key={i}
              elevation={4}
      ...
      <Container sx={{ mb: 10 }}>
        <Grid container spacing={4} alignItems="center">
          <Grid item xs={12} md={6}>
            <Typography variant="h4" sx={{ fontWeight: "bold", mb: 2, color: "primary.main" }}>About AIMS</Typography>
            ...
            <Typography variant="body1" paragraph>
              Our mission is to make inventory management smarter, faster, and more reliable — for businesses of all sizes.
            </Typography>
          </Grid>
          <Grid item xs={12} md={6}>
      ...
      <Box sx={{ backgroundColor: "#f8f9fa", py: 6, textAlign: "center", borderTop: "1px solid #ddd" }}>
        ...
        <Box>
          <IconButton href="https://github.com/" target="_blank" sx={{ color: "#333", "&:hover": { color: "#1976d2", transform: "scale(1.2)" }, transition: "0.3s" }}><GitHub /></IconButton>
          <IconButton href="https://linkedin.com/" target="_blank" sx={{ color: "#333", "&:hover": { color: "#0a66c2", transform: "scale(1.2)" }, transition: "0.3s" }}><LinkedIn /></IconButton>
          <IconButton href="mailto:support@aims.com" sx={{ color: "#333", "&:hover": { color: "#d93025", transform: "scale(1.2)" }, transition: "0.3s" }}><Email /></IconButton>
        </Box>
        <Typography variant="body2" color="text.secondary" mt={2}>© {new Date().getFullYear()} AIMS. All rights reserved.</Typography>
      </Box>
    </>
  );
}
