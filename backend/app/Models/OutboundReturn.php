...
class OutboundReturn extends Model
{
    ...
    protected $table = 'outbound_returns';
    ...
    public function order(){return $this->belongsTo(SalesOrder::class,'sales_order_id');} public function allocation(){return $this->belongsTo(OutboundAllocation::class,'outbound_allocation_id');}
}
